  ...
  return (
    <>
      ...
      >
        ...
        >
          {projects.map((project, index) => {
            ...
            return (
              <div
                className="modal relative h-full flex items-center justify-center rounded "
                key={index}
              >
                <Image
                  src={image}
      ...
      {/* <motion.div
        ...
        initial={"initial"}
        animate={active ? "open" : "closed"}
        className="cursoeLabel  w-16 h-16 bg-lime absolute user-select-none rounded-full flex items-center justify-center text-white bg-transparent pointer-events-none cursor-pointer"
        ref={cursorLabel}
      >
